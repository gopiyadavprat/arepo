...
export function Philosophy() {
    ...
    return (
        <section className="relative bg-void py-40 md:py-60">
            {/* Background accent */}
            ...
            <div className="container mx-auto px-4 md:px-10">
                ...
                <p ref={textRef} className="flex flex-wrap font-display text-4xl uppercase leading-[1.3] tracking-tight md:text-6xl lg:text-7xl">
